...
#define BYTE unsigned char //Potential replacement for 'unsigned char' with BYTE
...
int digest_equal(struct Digest *digest1, struct Digest *digest2); //return 1 if equal, 0 if otherwise
